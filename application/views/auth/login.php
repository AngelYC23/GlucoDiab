    ...
    <body class="login-page">
        <div class="login-container">
            <div class="login-card">
                ...
                <form class="login-form" id="loginForm" action="<?= site_url('auth/do_login') ?>" method="post" novalidate>
                ...
                <div class="signup-link">
                    <p>¿No tienes una cuenta? 
                        <a href="<?= site_url('auth/register') ?>">Regístrate</a>
                    </p>
                </div>
                ...
                <div class="success-message" id="successMessage">
                    ...
                    <h3>¡Éxito!</h3>
                    <p>Redirigiendo a tu página principal...</p>
                </div>
            </div>
        </div>
